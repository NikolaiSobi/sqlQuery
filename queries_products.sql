...
-- 7 INSERT INTO products (name, price, can_be_returned) VALUES ('door', 75.00, false);
-- 8 SELECT name FROM products WHERE can_be_returned = true;
-- 9 SELECT name FROM products WHERE price < 44;
-- 10 SELECT name FROM products WHERE price BETWEEN 22.50 AND 99.99;
-- 11 UPDATE products SET price = price * .8;
